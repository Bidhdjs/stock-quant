...
VCP_PLUS_MA_50_PERIOD = 50
VCP_PLUS_MA_150_PERIOD = 150
VCP_PLUS_MA_200_PERIOD = 200
VCP_PLUS_MA_TREND_PERIOD = 20
VCP_PLUS_RS_TREND_PERIOD = 20
VCP_PLUS_WEEK_WINDOW = 260
VCP_PLUS_LOCAL_EXTREMA_ORDER = 10
VCP_PLUS_MIN_CONTRACTIONS = 2
VCP_PLUS_MAX_CONTRACTIONS = 4
VCP_PLUS_MAX_CONTRACTION_DEPTH = 50.0
VCP_PLUS_MIN_CONTRACTION_DEPTH = 15.0
VCP_PLUS_MIN_WEEKS = 2
VCP_PLUS_VOL_SHORT_PERIOD = 5
VCP_PLUS_VOL_LONG_PERIOD = 30
VCP_PLUS_LOOKBACK_PERIOD = 520
VCP_PLUS_REQUIRE_RS_SLOPE = True
VCP_PLUS_REQUIRE_RS_RATING = True
VCP_PLUS_MIN_RS_RATING = 70
VCP_PLUS_REQUIRE_CONSOLIDATION = True
VCP_PLUS_EMA_SELL_PERIOD = 5
VCP_PLUS_BENCHMARK_CLOSE_COLUMN = "benchmark_close"
VCP_PLUS_RS_RATING_COLUMN = "rs_rating"
